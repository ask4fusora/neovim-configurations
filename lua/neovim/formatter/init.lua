---@class FormatterKind.LanguageServerChoice
---@field name string

---@class FormatterKind.LanguageServer
---@field language_server FormatterKind.LanguageServerChoice

---@class FormatterKind.External.ExternalCommand
---@field command string
---@field arguments string[]?

---@class FormatterKind.External
---@field external FormatterKind.External.ExternalCommand

---@class FormatterKind.CodeAction
---@field code_action string

---@alias FormatterKind FormatterKind.LanguageServer|FormatterKind.External|FormatterKind.CodeAction

---@param formatters FormatterKind[]
